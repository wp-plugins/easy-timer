...
'.(in_array('paypal_email_address', $_GET[$prefix.'fields']) ? '
if (form.'.$prefix.'paypal_email_address.value != "") {
if ((form.'.$prefix.'paypal_email_address.value.indexOf("@") == -1) || (form.'.$prefix.'paypal_email_address.value.indexOf(".") == -1)) {
if (document.getElementById("'.$prefix.'paypal_email_address_error")) { document.getElementById("'.$prefix.'paypal_email_address_error").innerHTML = "'.$_GET[$prefix.'invalid_email_address_message'].'"; }
if (!error) { form.'.$prefix.'paypal_email_address.focus(); } error = true; }
else if (document.getElementById("'.$prefix.'paypal_email_address_error")) { document.getElementById("'.$prefix.'paypal_email_address_error").innerHTML = ""; } }' : '').'
return !error; }
</script>';
...
if (($name == 'email_address') || ($name == 'paypal_email_address')) {
