...
case 'code': case 'content': case 'description': case 'message_confirmation_email_body': case 'message_custom_instructions': case 'message_notification_email_body': if (strlen($data) <= 80) { $table_td = $data; }
