...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="cookies_lifetime" id="cookies_lifetime" rows="1" cols="25"><?php echo $options['cookies_lifetime']; ?></textarea> <span style="vertical-align: 25%;"><?php _e('days', 'affiliation-manager'); ?> 
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="minimum_payout_amount" id="minimum_payout_amount" rows="1" cols="25"><?php echo $options['minimum_payout_amount']; ?></textarea> <span style="vertical-align: 25%;"><?php echo $currency_code; ?></span>
