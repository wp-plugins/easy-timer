...
$commerce_manager_options = array_map('htmlentities', $commerce_manager_options); ?>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="paypal_email_address" id="paypal_email_address" rows="1" cols="75"><?php echo $commerce_manager_options['paypal_email_address']; ?></textarea></td></tr>
...
<td><textarea style="float: left; margin-right: 1em; height: 20%; width: 75%;" name="email_to_customer_body" id="email_to_customer_body" rows="15" cols="75"><?php echo htmlentities(get_option('commerce_manager_email_to_customer_body')); ?></textarea>
...
<td><textarea style="float: left; margin-right: 1em; height: 20%; width: 75%;" name="email_to_seller_body" id="email_to_seller_body" rows="15" cols="75"><?php echo htmlentities(get_option('commerce_manager_email_to_seller_body')); ?></textarea>
<span class="description"><?php _e('You can insert shortcodes into <em>Subject</em> and <em>Body</em> fields to display informations about the customer, the product and the order.', 'commerce-manager'); ?> <a href="http://www.kleor-editions.com/commerce-manager/documentation/#email-shortcodes"><?php _e('More informations', 'commerce-manager'); ?></a></span></td></tr>
<tr valign="top"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php _e('Update'); ?>" /></td></tr>
</tbody></table>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="customers_aweber_list" id="customers_aweber_list" rows="1" cols="75"><?php echo $commerce_manager_options['customers_aweber_list']; ?></textarea></td></tr>
<tr valign="top"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php _e('Update'); ?>" /></td></tr>
</tbody></table>
</div></div>
