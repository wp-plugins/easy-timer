...
if ($_POST['registration_confirmation_email_sent'] != 'yes') { $_POST['registration_confirmation_email_sent'] = 'no'; }
if ($_POST['registration_notification_email_sent'] != 'yes') { $_POST['registration_notification_email_sent'] = 'no'; }
...
if ($_POST['registration_confirmation_email_body'] == '') { $_POST['registration_confirmation_email_body'] = $initial_options['registration_confirmation_email_body']; }
update_option('affiliation_manager_registration_confirmation_email_body', $_POST['registration_confirmation_email_body']);
if ($_POST['registration_notification_email_body'] == '') { $_POST['registration_notification_email_body'] = $initial_options['registration_notification_email_body']; }
update_option('affiliation_manager_registration_notification_email_body', $_POST['registration_notification_email_body']);
...
<table class="form-table"><tbody>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="checkbox" name="registration_notification_email_sent" id="registration_notification_email_sent" value="yes"<?php if ($options['registration_notification_email_sent'] == 'yes') { echo ' checked="checked"'; } ?> /> <label for="registration_notification_email_sent"><?php _e('Send a registration notification email', 'affiliation-manager'); ?></label></td></tr>
