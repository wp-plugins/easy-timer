...
if ($_POST['affiliates_subscribed_to_aweber_list'] != 'yes') { $_POST['affiliates_subscribed_to_aweber_list'] = 'no'; }
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="commission_amount" id="commission_amount" rows="1" cols="25"><?php echo $affiliation_manager_options['commission_amount']; ?></textarea>  <span style="vertical-align: 25%;"><?php echo $currency_code; ?></span><br />
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="minimum_payout_amount" id="minimum_payout_amount" rows="1" cols="25"><?php echo $affiliation_manager_options['minimum_payout_amount']; ?></textarea> <span style="vertical-align: 25%;"><?php echo $currency_code; ?></span></td></tr>
<tr valign="top"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php _e('Update'); ?>" /></td></tr>
</tbody></table>
</div></div>
