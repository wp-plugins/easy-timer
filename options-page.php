...
if ($_POST['cookies_lifetime'] < 1) { $_POST['cookies_lifetime'] = $affiliation_manager_initial_options['cookies_lifetime']; }
...
if ($_POST['maximum_login_length'] < 2) { $_POST['maximum_login_length'] = $affiliation_manager_initial_options['maximum_login_length']; }
$_POST['maximum_password_length'] = (int) $_POST['maximum_password_length'];
if ($_POST['maximum_password_length'] < 8) { $_POST['maximum_password_length'] = $affiliation_manager_initial_options['maximum_password_length']; }
$_POST['minimum_login_length'] = (int) $_POST['minimum_login_length'];
if ($_POST['minimum_login_length'] < 1) { $_POST['minimum_login_length'] = $affiliation_manager_initial_options['minimum_login_length']; }
...
if ($_POST['minimum_password_length'] < 1) { $_POST['minimum_password_length'] = $affiliation_manager_initial_options['minimum_password_length']; }
...
if ($_POST[$key] != '') { $affiliation_manager_options[$key] = $_POST[$key]; }
else { $affiliation_manager_options[$key] = $affiliation_manager_initial_options[$key]; } }
update_option('affiliation_manager', $affiliation_manager_options);
if ($_POST['email_to_affiliate_body'] == '') { $_POST['email_to_affiliate_body'] = $affiliation_manager_initial_email_to_affiliate_body; }
update_option('affiliation_manager_email_to_affiliate_body', $_POST['email_to_affiliate_body']);
if ($_POST['email_to_affiliator_body'] == '') { $_POST['email_to_affiliator_body'] = $affiliation_manager_initial_email_to_affiliator_body; }
update_option('affiliation_manager_email_to_affiliator_body', $_POST['email_to_affiliator_body']);
if ($_POST['password_reset_email_body'] == '') { $_POST['password_reset_email_body'] = $affiliation_manager_initial_password_reset_email_body; }
update_option('affiliation_manager_password_reset_email_body', $_POST['password_reset_email_body']); }
else { $affiliation_manager_options = (array) get_option('affiliation_manager'); }
...
<div class="clear"></div>
<p class="description"><?php _e('Leave each field blank to reset the corresponding option.', 'affiliation-manager'); ?></p>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="email_to_affiliate_receiver" id="email_to_affiliate_receiver" rows="1" cols="75"><?php echo $affiliation_manager_options['email_to_affiliate_receiver']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="email_to_affiliator_sender" id="email_to_affiliator_sender" rows="1" cols="75"><?php echo $affiliation_manager_options['email_to_affiliator_sender']; ?></textarea></td></tr>
...
<tr valign="top"><th scope="row" style="width: 20%;"><strong><label for="password_reset_email_receiver"><?php _e('Receiver', 'affiliation-manager'); ?></label></strong></th>
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="password_reset_email_receiver" id="password_reset_email_receiver" rows="1" cols="75"><?php echo $affiliation_manager_options['password_reset_email_receiver']; ?></textarea></td></tr>
<tr valign="top"><th scope="row" style="width: 20%;"><strong><label for="password_reset_email_subject"><?php _e('Subject', 'affiliation-manager'); ?></label></strong></th>
...
<table class="form-table"><tbody>
<tr valign="top"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><?php _e('You must make some adjustments so that the subscription works with AWeber.', 'affiliation-manager'); ?> <a href="http://www.kleor-editions.com/affiliation-manager/documentation/#autoresponders"><?php _e('More informations', 'affiliation-manager'); ?></a></span></td></tr>
<tr valign="top"><th scope="row" style="width: 20%;"></th>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="affiliate_autoresponder_list" id="affiliate_autoresponder_list" rows="1" cols="50"><?php echo $affiliation_manager_options['affiliate_autoresponder_list']; ?></textarea></td></tr>
<tr valign="top"><th scope="row" style="width: 20%;"></th>
...
<?php include_once 'autoresponders.php';
$autoresponder2 = affiliation_data('affiliate_autoresponder2');
foreach ($autoresponders as $key => $value) {
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="affiliate_autoresponder_list2" id="affiliate_autoresponder_list2" rows="1" cols="50"><?php echo $affiliation_manager_options['affiliate_autoresponder_list2']; ?></textarea></td></tr>
<tr valign="top"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php _e('Update'); ?>" /></td></tr>
</tbody></table>
</div></div>
