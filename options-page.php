...
<p style="margin: 1.5em"><a href="http://www.kleor-editions.com/<?php _e('easy-timer/en', 'easy-timer'); ?>"><?php _e('Documentation', 'easy-timer'); ?></a></p>
...
</select>. <a href="http://www.kleor-editions.com/<?php _e('easy-timer/en', 'easy-timer'); ?>/#timer-shortcodes"><?php _e('More informations', 'easy-timer'); ?></a><br />
