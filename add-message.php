...
if (is_admin()) { $message[$field] = stripslashes(do_shortcode($message[$field])); }
...
if (($_GET['user_id'] == 0) && ($message['sender_subscribed_as_a_user'] == 'yes')) {
...
$$field = $message['message_'.$action.'_email_'.$field]; }
if ($sent == 'yes') { wp_mail($receiver, $subject, $body, 'From: '.$sender); } }

if ($message['sender_subscribed_to_autoresponder'] == 'yes') {
