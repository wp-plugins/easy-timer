...
if ($error == '') { $results = $wpdb->query("INSERT INTO $affiliates_table_name (id, login, password, first_name, last_name, email_address, paypal_email_address, website_name, website_url, address, postcode, town, country, phone_number, commission_percentage, commission_amount, date, date_utc, user_agent, ip_address, referring_url, referrer) VALUES(
	'',
	'".$_POST['login']."',
...
<div class="postbox">
<h3 id="autoresponder"><?php _e('Autoresponder', 'affiliation-manager'); ?></h3>
<div class="inside">
<table class="form-table"><tbody>
<tr valign="top"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><a href="admin.php?page=affiliation-manager#autoresponder"><?php _e('Click here to configure the default options.', 'affiliation-manager'); ?></a></span></td></tr>
<tr valign="top"><th scope="row" style="width: 20%;"></th>
