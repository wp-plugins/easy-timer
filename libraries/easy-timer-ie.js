...
var offset = hmclock[el].title.substr(10);
hmclock[el].innerHTML = clock_update(offset, 'hm'); }

function hmsclock_update(el) {
var offset = hmsclock[el].title.substr(10);
