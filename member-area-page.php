...
echo '<div class="updated"><p><strong>'.($is_category ? __('Category deleted.', 'membership-manager') : __('Member area deleted.', 'membership-manager')).'</strong></p></div>
<script type="text/javascript">setTimeout(\'window.location = "admin.php?page=membership-manager-members-areas'.($is_category ? '-categories' : '').'"\', 2000);</script>'; } ?>
...
<?php echo ($is_category ? __('Do you really want to permanently delete this category?', 'membership-manager') : __('Do you really want to permanently delete this member area?', 'membership-manager')); ?> 
...
$back_office_options = update_membership_manager_back_office($back_office_options, $admin_page);
...
$updated = true;
include 'tables.php';
$sql = membership_sql_array($tables[$table_slug], $_POST);
...
elseif (!headers_sent()) { header('Location: admin.php?page=membership-manager-members-areas'.($is_category ? '-categories' : '')); exit(); }
else { echo '<script type="text/javascript">window.location = "admin.php?page=membership-manager-members-areas'.($is_category ? '-categories' : '').'";</script>'; } }
...
<?php membership_manager_pages_top($back_office_options); ?>
<?php if ($updated) {
echo '<div class="updated"><p><strong>'.(isset($_GET['id']) ? ($is_category ? __('Category updated.', 'membership-manager') : __('Member area updated.', 'membership-manager')) : ($is_category ? __('Category saved.', 'membership-manager') : __('Member area saved.', 'membership-manager'))).'</strong></p></div>
'.(isset($_GET['id']) ? '' : '<script type="text/javascript">setTimeout(\'window.location = "admin.php?page=membership-manager-members-areas'.($is_category ? '-categories' : '').'"\', 2000);</script>'); } ?>
<form method="post" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>">
<?php wp_nonce_field($_GET['page']); ?>
<?php membership_manager_pages_menu($back_office_options); ?>
<div class="clear"></div>
...
<span class="description" style="vertical-align: 25%;"><a href="http://www.kleor-editions.com/membership-manager/documentation/#included-members-areas"><?php _e('More informations', 'membership-manager'); ?></a></span>
...
<table class="form-table"><tbody>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><a href="admin.php?page=membership-manager<?php echo ($_POST['category_id'] == 0 ? '#registration' : '-member-area-category&amp;id='.$_POST['category_id'].'#registration'); ?>">
...
<?php foreach ($categories as $category) {
echo '<option value="'.$category->id.'"'.($_POST['members_initial_category_id'] == $category->id ? ' selected="selected"' : '').'>'.do_shortcode($category->name).'</option>'."\n"; } ?>
</select>
...
<span class="description"><?php _e('Status assigned to members upon their registration', 'membership-manager'); ?></span></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="activation_confirmation_url" id="activation_confirmation_url" rows="1" cols="75"><?php echo $_POST['activation_confirmation_url']; ?></textarea> 
<?php $url = htmlspecialchars(member_area_data(array(0 => 'activation_confirmation_url', 'part' => 1, $attribute => $_GET['id']))); if ($url != '') { ?><a style="vertical-align: 25%;" href="<?php echo $url; ?>"><?php _e('Link', 'membership-manager'); ?></a><?php } ?><br />
<span class="description" style="vertical-align: 25%;"><?php _e('Leave this field blank to apply the default option.', 'membership-manager'); ?></span></td></tr>
<?php if (isset($_GET['id'])) { echo '<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="'.__('Update').'" /></td></tr>'; } ?>
</tbody></table>
...
<a href="admin.php?page=<?php echo ($_POST['category_id'] == 0 ? 'membership-manager#registration-as-a-client' : 'membership-manager-member-area-category&amp;id='.$_POST['category_id'].'#registration-as-a-client'); ?>">
<?php ($_POST['category_id'] == 0 ? _e('Click here to configure the default options.', 'membership-manager') : ($is_category ? _e('Click here to configure the default options of the parent category.', 'membership-manager') : _e('Click here to configure the default options of the category.', 'membership-manager'))); ?></a>
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"><strong><label for="member_subscribed_as_a_client"><?php _e('Subscribe the member as a client', 'membership-manager'); ?></label></strong></th>
<td><select name="member_subscribed_as_a_client" id="member_subscribed_as_a_client">
<option value=""<?php if ($_POST['member_subscribed_as_a_client'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
<option value="yes"<?php if ($_POST['member_subscribed_as_a_client'] == 'yes') { echo ' selected="selected"'; } ?>><?php _e('Yes', 'membership-manager'); ?></option>
<option value="no"<?php if ($_POST['member_subscribed_as_a_client'] == 'no') { echo ' selected="selected"'; } ?>><?php _e('No', 'membership-manager'); ?></option>
</select>
<span class="description"><a href="http://www.kleor-editions.com/membership-manager/documentation/#registration-as-a-client"><?php _e('More informations', 'membership-manager'); ?></a></span></td></tr>
...
<option value=""<?php if ($_POST['member_client_category_id'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
...
<option value=""<?php if ($_POST['member_client_status'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
...
<option value=""<?php if ($_POST['commerce_registration_confirmation_email_sent'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
<option value="yes"<?php if ($_POST['commerce_registration_confirmation_email_sent'] == 'yes') { echo ' selected="selected"'; } ?>><?php _e('Yes', 'membership-manager'); ?></option>
<option value="no"<?php if ($_POST['commerce_registration_confirmation_email_sent'] == 'no') { echo ' selected="selected"'; } ?>><?php _e('No', 'membership-manager'); ?></option>
</select></td></tr>
...
<option value=""<?php if ($_POST['commerce_registration_notification_email_sent'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
<option value="yes"<?php if ($_POST['commerce_registration_notification_email_sent'] == 'yes') { echo ' selected="selected"'; } ?>><?php _e('Yes', 'membership-manager'); ?></option>
<option value="no"<?php if ($_POST['commerce_registration_notification_email_sent'] == 'no') { echo ' selected="selected"'; } ?>><?php _e('No', 'membership-manager'); ?></option>
</select></td></tr>
<?php if (isset($_GET['id'])) { echo '<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="'.__('Update').'" /></td></tr>'; } ?>
</tbody></table>
...
<a href="admin.php?page=<?php echo ($_POST['category_id'] == 0 ? 'membership-manager#registration-to-affiliate-program' : 'membership-manager-member-area-category&amp;id='.$_POST['category_id'].'#registration-to-affiliate-program'); ?>">
<?php ($_POST['category_id'] == 0 ? _e('Click here to configure the default options.', 'membership-manager') : ($is_category ? _e('Click here to configure the default options of the parent category.', 'membership-manager') : _e('Click here to configure the default options of the category.', 'membership-manager'))); ?></a>
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"><strong><label for="member_subscribed_to_affiliate_program"><?php _e('Subscribe the member to affiliate program', 'membership-manager'); ?></label></strong></th>
<td><select name="member_subscribed_to_affiliate_program" id="member_subscribed_to_affiliate_program">
<option value=""<?php if ($_POST['member_subscribed_to_affiliate_program'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
<option value="yes"<?php if ($_POST['member_subscribed_to_affiliate_program'] == 'yes') { echo ' selected="selected"'; } ?>><?php _e('Yes', 'membership-manager'); ?></option>
<option value="no"<?php if ($_POST['member_subscribed_to_affiliate_program'] == 'no') { echo ' selected="selected"'; } ?>><?php _e('No', 'membership-manager'); ?></option>
</select>
<span class="description"><a href="http://www.kleor-editions.com/membership-manager/documentation/#registration-to-affiliate-program"><?php _e('More informations', 'membership-manager'); ?></a></span></td></tr>
...
<option value=""<?php if ($_POST['member_affiliate_category_id'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
...
<option value=""<?php if ($_POST['member_affiliate_status'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
...
<option value=""<?php if ($_POST['affiliation_registration_confirmation_email_sent'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
<option value="yes"<?php if ($_POST['affiliation_registration_confirmation_email_sent'] == 'yes') { echo ' selected="selected"'; } ?>><?php _e('Yes', 'membership-manager'); ?></option>
<option value="no"<?php if ($_POST['affiliation_registration_confirmation_email_sent'] == 'no') { echo ' selected="selected"'; } ?>><?php _e('No', 'membership-manager'); ?></option>
</select></td></tr>
...
<option value=""<?php if ($_POST['affiliation_registration_notification_email_sent'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
<option value="yes"<?php if ($_POST['affiliation_registration_notification_email_sent'] == 'yes') { echo ' selected="selected"'; } ?>><?php _e('Yes', 'membership-manager'); ?></option>
<option value="no"<?php if ($_POST['affiliation_registration_notification_email_sent'] == 'no') { echo ' selected="selected"'; } ?>><?php _e('No', 'membership-manager'); ?></option>
</select></td></tr>
<?php if (isset($_GET['id'])) { echo '<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="'.__('Update').'" /></td></tr>'; } ?>
</tbody></table>
...
<table class="form-table"><tbody>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><a href="admin.php?page=membership-manager<?php echo ($_POST['category_id'] == 0 ? '#wordpress' : '-member-area-category&amp;id='.$_POST['category_id'].'#wordpress'); ?>">
<?php ($_POST['category_id'] == 0 ? _e('Click here to configure the default options.', 'membership-manager') : ($is_category ? _e('Click here to configure the default options of the parent category.', 'membership-manager') : _e('Click here to configure the default options of the category.', 'membership-manager'))); ?></a></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"><strong><label for="member_subscribed_as_a_user"><?php _e('Subscribe the member as a user', 'membership-manager'); ?></label></strong></th>
<td><select name="member_subscribed_as_a_user" id="member_subscribed_as_a_user">
<option value=""<?php if ($_POST['member_subscribed_as_a_user'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
<option value="yes"<?php if ($_POST['member_subscribed_as_a_user'] == 'yes') { echo ' selected="selected"'; } ?>><?php _e('Yes', 'membership-manager'); ?></option>
<option value="no"<?php if ($_POST['member_subscribed_as_a_user'] == 'no') { echo ' selected="selected"'; } ?>><?php _e('No', 'membership-manager'); ?></option>
</select>
<span class="description"><a href="http://www.kleor-editions.com/membership-manager/documentation/#wordpress"><?php _e('More informations', 'membership-manager'); ?></a></span></td></tr>
...
<option value=""<?php if ($_POST['member_user_role'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
...
<table class="form-table"><tbody>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><a href="admin.php?page=membership-manager<?php echo ($_POST['category_id'] == 0 ? '#activation-confirmation-email' : '-member-area-category&amp;id='.$_POST['category_id'].'#activation-confirmation-email'); ?>">
<?php ($_POST['category_id'] == 0 ? _e('Click here to configure the default options.', 'membership-manager') : ($is_category ? _e('Click here to configure the default options of the parent category.', 'membership-manager') : _e('Click here to configure the default options of the category.', 'membership-manager'))); ?></a></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"><strong><label for="activation_confirmation_email_sent"><?php _e('Send an activation confirmation email', 'membership-manager'); ?></label></strong></th>
<td><select name="activation_confirmation_email_sent" id="activation_confirmation_email_sent">
<option value=""<?php if ($_POST['activation_confirmation_email_sent'] == '') { echo ' selected="selected"'; } ?>><?php _e('Default option', 'membership-manager'); ?></option>
<option value="yes"<?php if ($_POST['activation_confirmation_email_sent'] == 'yes') { echo ' selected="selected"'; } ?>><?php _e('Yes', 'membership-manager'); ?></option>
<option value="no"<?php if ($_POST['activation_confirmation_email_sent'] == 'no') { echo ' selected="selected"'; } ?>><?php _e('No', 'membership-manager'); ?></option>
</select></td></tr>
