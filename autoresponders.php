...
if ($list != '') {
$user['email_address'] = affiliation_format_email_address($user['email_address']);
$user['referrer'] = affiliation_format_nice_name($user['referrer']);
$user['website_url'] = affiliation_format_url($user['website_url']);
...
"\nName: ".affiliation_strip_accents($user['first_name']).
