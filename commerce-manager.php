...
if ((isset($_SESSION['order_id'])) && ($_SESSION['order_data']->id != $_SESSION['order_id'])) {
$_SESSION['order_data'] = $wpdb->get_row("SELECT * FROM $orders_table_name WHERE id = '".$_SESSION['order_id']."'", OBJECT); }
...
if (!isset($_SESSION['order_id'])) { $_SESSION['order_id'] = $id; }
$order_data = $wpdb->get_row("SELECT * FROM $orders_table_name WHERE id = '$id'", OBJECT);
if (!isset($_SESSION['order_data'])) { $_SESSION['order_data'] = $order_data; }
...
function product_data_counter($atts, $content) {
global $products_table_name, $wpdb;
if ((isset($_GET['product_id'])) && ($_GET['product_data']->id != $_GET['product_id'])) {
$_GET['product_data'] = $wpdb->get_row("SELECT * FROM $products_table_name WHERE id = '".$_GET['product_id']."'", OBJECT); }
$product_data = $_GET['product_data'];
...
return product_data_counter($atts, $content); }
