...
if ($error == '') { $results = $wpdb->query("INSERT INTO $products_table_name VALUES(
	'',
	'".$_POST['name']."',
	'".$_POST['price']."',
	'".$_POST['shipping_cost']."',
...
$results = $wpdb->query("UPDATE $products_table_name SET
	...
	date = '".$_POST['date']."',
	date_utc = '".$date_utc."' WHERE id = '".$_GET['id']."'"); } }
...
<div class="postbox">
<h3><?php _e('Inventory', 'commerce-manager'); ?></h3>
<div class="inside">
<table class="form-table"><tbody>
...
<div class="postbox">
<h3><?php _e('Order', 'commerce-manager'); ?></h3>
<div class="inside">
<table class="form-table"><tbody>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="price" id="price" rows="1" cols="25"><?php echo $_POST['price']; ?></textarea> <span style="vertical-align: 25%;"><?php echo do_shortcode($commerce_manager_options['currency_code']); ?></span></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="shipping_cost" id="shipping_cost" rows="1" cols="25"><?php echo $_POST['shipping_cost']; ?></textarea> <span style="vertical-align: 25%;"><?php echo do_shortcode($commerce_manager_options['currency_code']); ?></span></td></tr>
...
<div class="postbox">
<h3><?php _e('Autorespondeur', 'commerce-manager'); ?></h3>
<div class="inside">
<table class="form-table"><tbody>
<tr valign="top"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><a href="admin.php?page=commerce-manager"><?php _e('Click here to configure the default options.', 'commerce-manager'); ?></a></span></td></tr>
...
<option value="constant"<?php if ($_POST['commission_type'] == 'constant') { echo ' selected="selected"'; } ?>><?php _e('Constante', 'commerce-manager'); ?></option>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="commission_percentage" id="commission_percentage" rows="1" cols="25"><?php echo $_POST['commission_percentage']; ?></textarea> <span style="vertical-align: 25%;">% <?php _e('of the price', 'commerce-manager'); ?></span><br />
<span class="description"><?php _e('Used for instant payment affiliation and for deferred payment affiliation if you use proportional commissions', 'commerce-manager'); ?><br />
...
<span class="description"><?php _e('Used if you select constant commissions', 'commerce-manager'); ?><br />
<?php _e('Leave this field blank to apply the default option.', 'commerce-manager'); ?></span></td></tr>
...
<span class="description"><a href="http://www.kleor-editions.com/affiliation-manager/documentation/#first-sale-award"><?php _e('More informations', 'commerce-manager'); ?></a></span></td></tr>
<?php if (isset($_GET['id'])) { echo '<tr valign="top"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="'.__('Update').'" /></td></tr>'; } ?>
</tbody></table>
</div></div>
<p class="submit" style="margin: 0 20%;"><input type="submit" class="button-primary" name="submit" id="submit" value="<?php echo (isset($_GET['id']) ?  __('Save Changes', 'commerce-manager') : __('Save product', 'commerce-manager')); ?>" /></p>
</form>
</div>
</div>
<?php }