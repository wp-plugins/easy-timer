...
'messages_registration_enabled' => 'yes',
...
<p><strong>[label first-name]'.__('Your first name:', 'contact-manager').'[/label]</strong>*<br />
[input first-name size=30 required=yes]<br />[error style="color: red;" first-name]</label></p>

<p><strong>[label last-name]'.__('Your last name:', 'contact-manager').'[/label]</strong>*<br />
[input last-name size=30]<br />[error style="color: red;" last-name]</label></p>

<p><strong>[label email-address]'.__('Your email address:', 'contact-manager').'[/label]</strong>*<br />
[input email-address size=40 required=yes]<br />[error style="color: red;" email-address]</label></p>

<p><strong>[label website]'.__('Your website:', 'contact-manager').'[/label]</strong>*<br />
[input website size=40]<br />[error style="color: red;" website]</label></p>

<p><strong>[label subject]'.__('Subject of your message:', 'contact-manager').'[/label]</strong>*<br />
[input subject size=60 required=yes]<br />[error style="color: red;" subject]</label></p>

<p><strong>[label content]'.__('Your message:', 'contact-manager').'[/label]</strong>*<br />
[textarea content cols=60 rows=15 required=yes][textarea]<br />[error style="color: red;" content]</label></p>
...
--
'.__('Sended through this form:', 'contact-manager').' [contact-form name]';
