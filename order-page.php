...
if ($_POST['submit'] == __('Complete the fields below with the informations about the customer, the product and the order', 'commerce-manager')) {
...
foreach ($fields as $key => $field) { $_POST[$field] = str_replace('[order id[', '[order id]', product_data($field)); } }
...
<div id="poststuff">
<?php commerce_manager_pages_top(); ?>
<?php if ((isset($_POST['submit'])) && ($error == '') && ($_POST['submit'] != __('Complete the fields below with the informations about the customer, the product and the order', 'commerce-manager'))) { echo '<div class="updated"><p><strong>'.(isset($_GET['id']) ? __('Order updated.', 'commerce-manager') : __('Order saved.', 'commerce-manager')).'</strong></p></div>'; } ?>
<form method="post" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>">
<?php wp_nonce_field($_GET['page']); ?>
<?php commerce_manager_pages_menu(); ?>
...
<p class="submit" style="margin: 0 20%;"><input type="submit" class="button-secondary" name="submit" value="<?php _e('Complete the fields below with the informations about the customer, the product and the order', 'commerce-manager'); ?>" /></p>
<div class="postbox">
...
<?php if ($_POST['submit'] == __('Complete the fields below with the informations about the customer, the product and the order', 'commerce-manager')) { ?>
