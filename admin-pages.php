...
'form' => array('page_title' => 'Contact Manager ('.__('Form', 'contact-manager').')', 'menu_title' => ((($_GET['page'] == 'contact-manager-form') && (isset($_GET['id']))) ? ($_GET['action'] == 'delete' ? __('Delete Form', 'contact-manager') : __('Edit Form', 'contact-manager')) : __('Add Form', 'contact-manager')), 'file' => 'form-page.php'),
'forms' => array('page_title' => 'Contact Manager ('.__('Forms', 'contact-manager').')', 'menu_title' => __('Forms', 'contact-manager'), 'file' => 'table-page.php'),
'form_category' => array('page_title' => 'Contact Manager ('.__('Form Category', 'contact-manager').')', 'menu_title' => ((($_GET['page'] == 'contact-manager-form-category') && (isset($_GET['id']))) ? ($_GET['action'] == 'delete' ? __('Delete Form Category', 'contact-manager') : __('Edit Form Category', 'contact-manager')) : __('Add Form Category', 'contact-manager')), 'file' => 'form-page.php'),
...
'message' => array('page_title' => 'Contact Manager ('.__('Message', 'contact-manager').')', 'menu_title' => ((($_GET['page'] == 'contact-manager-message') && (isset($_GET['id']))) ? ($_GET['action'] == 'delete' ? __('Delete Message', 'contact-manager') : __('Edit Message', 'contact-manager')) : __('Add Message', 'contact-manager')), 'file' => 'message-page.php'),
