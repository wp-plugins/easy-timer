...
<li>| <a href="admin.php?page=affiliation-manager-clicks"<?php if ($_GET['page'] == 'affiliation-manager-clicks') { echo ' class="current"'; } ?>><?php _e('Clicks', 'affiliation-manager'); ?></a></li>
...
<li>| <a href="admin.php?page=commerce-manager">Commerce Manager</a></li><?php } ?>
</ul>
<div class="clear"></div>
<?php }
...
if ($_GET['page'] == 'affiliation-manager-statistics') { add_action('admin_head', 'affiliation_statistics_form_css'); }