...
$content = str_ireplace('['.$prefix.'dhmstimer]', '<span class="dhmscount'.$way.'" id="t'.mt_rand(10000000, 99999999).'-'.$T.'">'.$timer['Dhms'].'</span>', $content);
$content = str_ireplace('['.$prefix.'dhmtimer]', '<span class="dhmcount'.$way.'" id="t'.mt_rand(10000000, 99999999).'-'.$T.'">'.$timer['Dhm'].'</span>', $content);
$content = str_ireplace('['.$prefix.'dhtimer]', '<span class="dhcount'.$way.'" id="t'.mt_rand(10000000, 99999999).'-'.$T.'">'.$timer['Dh'].'</span>', $content);
$content = str_ireplace('['.$prefix.'dtimer]', '<span class="dcount'.$way.'" id="t'.mt_rand(10000000, 99999999).'-'.$T.'">'.$timer['D'].'</span>', $content);
$content = str_ireplace('['.$prefix.'hmstimer]', '<span class="hmscount'.$way.'" id="t'.mt_rand(10000000, 99999999).'-'.$T.'">'.$timer['Hms'].'</span>', $content);
$content = str_ireplace('['.$prefix.'hmtimer]', '<span class="hmcount'.$way.'" id="t'.mt_rand(10000000, 99999999).'-'.$T.'">'.$timer['Hm'].'</span>', $content);
$content = str_ireplace('['.$prefix.'htimer]', '<span class="hcount'.$way.'" id="t'.mt_rand(10000000, 99999999).'-'.$T.'">'.$timer['H'].'</span>', $content);
$content = str_ireplace('['.$prefix.'mstimer]', '<span class="mscount'.$way.'" id="t'.mt_rand(10000000, 99999999).'-'.$T.'">'.$timer['Ms'].'</span>', $content);
$content = str_ireplace('['.$prefix.'mtimer]', '<span class="mcount'.$way.'" id="t'.mt_rand(10000000, 99999999).'-'.$T.'">'.$timer['M'].'</span>', $content);
$content = str_ireplace('['.$prefix.'stimer]', '<span class="scount'.$way.'" id="t'.mt_rand(10000000, 99999999).'-'.$T.'">'.$timer['S'].'</span>', $content);
...
if ((EASY_TIMER_OPTIONS_JAVASCRIPT_ENABLED == 'yes') && (stristr($content[$k], 'timer]'))) {
