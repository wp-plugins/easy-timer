...
function install_easy_timer() { require_once dirname(__FILE__).'/install.php'; }
...
if (!function_exists('adodb_mktime')) { require_once 'adodb-time.php'; }
...
if (is_admin()) {
function easy_timer_options_page() { include_once 'options-page.php'; }
