...
var stringdays = '<?php _e('days', 'easy-timer'); ?>';
var stringhours = '<?php _e('hours', 'easy-timer'); ?>';
var stringminutes = '<?php _e('minutes', 'easy-timer'); ?>';
var stringseconds = '<?php _e('seconds', 'easy-timer'); ?>';
