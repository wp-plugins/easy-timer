...
add_option('affiliation_manager_email_to_affiliate_body', __('Thank you for your registration to our affiliate program', 'affiliation-manager').', [affiliate first-name].
...
add_option('affiliation_manager_email_to_affiliator_body', '[affiliate first-name] [affiliate last-name]
...
'.__('Company', 'affiliation-manager').': [affiliate company]
'.__('Website', 'affiliation-manager').': [affiliate website]
...
add_option('affiliation_manager_password_reset_email_body', __('Hi', 'affiliation-manager').', [affiliate first-name].
