...
add_option('affiliation_manager_affiliates_page_display_limit', 20);
add_option('affiliation_manager_clicks_page_display_limit', 20);
add_option('affiliation_manager_commissions_page_display_limit', 20);
