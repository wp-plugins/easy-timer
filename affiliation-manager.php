...
$date = date('Y-m-d H:i:s', time() + 3600*get_option('gmt_offset'));
$date_utc = date('Y-m-d H:i:s');
$results = $wpdb->query("INSERT INTO $affiliates_table_name VALUES(
	'',
	'".$login."',
	...
	'".$_POST['a_website_name']."',
	'".$_POST['a_website_url']."',
	'".$_POST['a_address']."',
	'".$_POST['a_postcode']."',
	'".$_POST['a_town']."',
	'".$_POST['a_country']."',
	'".$_POST['a_phone_number']."',
	'',
	'',
	'".$date."',
	'".$date_utc."',
...
if (isset($_POST['a_submit'])) { $start_date = $_POST['start_date']; $end_date = $_POST['end_date']; }
